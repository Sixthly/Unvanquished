...
static void CG_CompleteClass( void )
{
	...
	{
		static const char classes[][12] = { "builder", "builderupg", "level0", "level1", "level1upg",
		                                    "level2", "level2upg", "level3", "level3upg", "level4"
		                                  };
...
static void CG_CompleteBuySell( qboolean buying )
{
	...
	static const char items[][12] = { "weapons", "upgrades", // <- only valid when selling
	                                  "ckit", "rifle", "psaw", "shotgun", "lgun", "mdriver", "chaingun",
	                                  "prifle", "flamer", "lcannon", "larmour", "helmet", "bsuit", "grenade",
	                                  "battpack", "jetpack", "ammo"
	                                };
...
static void CG_CompleteBuild( void )
{
	...
	if ( cgs.clientinfo[cg.clientNum].team == TEAM_ALIENS )
	{
		static const char structs[][12] = { "eggpod", "overmind", "barricade", "acid_tube", "trapper",
		                                    "booster", "hive"
		                                  };
	...
	{
		static const char structs[][12] = { "telenode", "mgturret", "tesla", "arm", "dcc", "medistat", "reactor", "repeater" };
